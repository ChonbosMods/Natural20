...
- Affix loot now appears in world-generated loot chests (dungeons, ruins) and in settlement chests, generated the first time you open the chest. Previously a chest could hand out a duplicate of a non-stackable item (shown as a stack of two), its contents could briefly render as "invalid item" on opening, and nat20 loot could reappear in chests you had already emptied, broken and re-placed, or crafted yourself. Loot is now generated once on first open, never duplicates, and never lands in chests you placed yourself.
