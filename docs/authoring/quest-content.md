# Quest Content Authoring Guide

Quick checklist version: `src/main/resources/quests/AUTHORING_RULES.md`
For topic pool authoring: see `pools.md`, `rumor-pools.md`, `smalltalk-pools.md`, `detail-responses.md`
