 ...
 * {@code nat20:indestructible}. Verifies that shape mining cascade interacts correctly with
 * the bytecode durability patch (every cascade block should break but never consume durability).
 */
public class TestDelveIndestructibleCommand extends AbstractPlayerCommand {

    public TestDelveIndestructibleCommand() {
        super("testdelveindest", "Give a Legendary Iron Pickaxe with Delve + Indestructible");
    }
    ...
    protected void execute(@Nonnull CommandContext context,
        ...
        lootData.setAffixes(List.of(
            ...
            new RolledAffix("nat20:indestructible", 1.0)
        ));
        lootData.setSockets(0);
        lootData.setGeneratedName("Delve + Indestructible Pickaxe");
        ...
        context.sendMessage(Message.raw("Gave: " + lootData.getGeneratedName()
            + " [Legendary] (Delve cascade + no durability loss)"));
    }
}
