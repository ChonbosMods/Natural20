...
public class TestArmorCommand extends AbstractPlayerCommand {

    private final RequiredArg<String> affixArg =
        withRequiredArg("affix", "Affix ID: gallant, thorns, evasion, etc.", ArgTypes.STRING);

    public TestArmorCommand() {
        super("testarmor", "Give an Iron Chestplate with a specific affix: /nat20 testarmor gallant");
    }
    ...
    protected void execute(@Nonnull CommandContext context,
        ...
        lootData.setGeneratedName("Test " + capitalize(input) + " Chestplate");
        lootData.setNameSuffixSource(affixId);

        ItemStack stack = new ItemStack("Armor_Iron_Chest", 1);
        ...
        context.sendMessage(Message.raw("Gave: Test " + capitalize(input)
            + " Chestplate [Rare] with affix " + affixId));
    }
